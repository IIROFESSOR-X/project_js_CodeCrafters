...
function formatNumericOfPages(cPage, tPage) {
  ...
  let leftErrow = `<svg  class="page-choice-svg"  width="18"  height="18"    data-id="left"  
  ...
  let rightErrow = `<svg class="page-choice-svg" data-id="right"   xmlns="http://www.w3.org/2000/svg" id="Outline"
